GermaNet Release 15.0 - InterlingualIndex Mapping
=================================================
...
http://www.sfs.uni-tuebingen.de/GermaNet/xml.shtml

Installation
============

To use the mappings, copy this XML file to the XML folder in the GermaNet Release 15.0 data, replacing the file with the same name.
